...
import 'package:gyst/templates/todo_page.dart';
import 'package:gyst/templates/notes.dart';
import 'package:gyst/templates/watch_page.dart';
          ...
          InkWell(
            ...
            child: Container(decoration: BoxDecoration(borderRadius: BorderRadius.circular(20), color: const Color(0xFFB7B7D4)),
              child: Column(
                ...
                children: const [
                Text("Study Planner", style: TextStyle(color: Colors.black, fontSize: 20, fontWeight: FontWeight.bold),)
              ],),
            ),
          ),
          InkWell(
            ...
            child: Container(decoration: BoxDecoration(borderRadius: BorderRadius.circular(20), color: const Color(0xFFB7B7D4)),
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: const [
                Text("Month Planner", style: TextStyle(color: Colors.black, fontSize: 20, fontWeight: FontWeight.bold),)
              ],),
            ),
          ),
          InkWell(
            ...
            child: Container(decoration: BoxDecoration(borderRadius: BorderRadius.circular(20), color: const Color(0xFFB7B7D4)),
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: const [
                Text("Shopping List", style: TextStyle(color: Colors.black, fontSize: 20, fontWeight: FontWeight.bold),)
              ],),
            ),
          ),
          InkWell(
            ...
            child: Container(decoration: BoxDecoration(borderRadius: BorderRadius.circular(20), color: const Color(0xFFB7B7D4)),
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: const [
                Text("Workout", style: TextStyle(color: Colors.black, fontSize: 20, fontWeight: FontWeight.bold),)
              ],),
            ),
          ),
          InkWell(
            ...
            child: Container(decoration: BoxDecoration(borderRadius: BorderRadius.circular(20), color: const Color(0xFFB7B7D4)),
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: const [
                Text("To Do List", style: TextStyle(color: Colors.black, fontSize: 20, fontWeight: FontWeight.bold),)
              ],),
            ),
          ),
          InkWell(
            ...
            child: Container(decoration: BoxDecoration(borderRadius: BorderRadius.circular(20), color: const Color(0xFFB7B7D4)),
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: const [
                Text("Watch List", style: TextStyle(color: Colors.black, fontSize: 20, fontWeight: FontWeight.bold),)
              ],),
            ),
          ),
          InkWell(
            ...
            child: Container(decoration: BoxDecoration(borderRadius: BorderRadius.circular(20), color: const Color(0xFFB7B7D4)),
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: const [
                Text("Quick notes", style: TextStyle(color: Colors.black, fontSize: 20, fontWeight: FontWeight.bold),)
              ],),
            ),
          ),
        ],
